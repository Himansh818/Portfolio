    ...
    <div className=' projects h-auto  w-full text-2xl flex flex-col justify-center items-center text-black '>
        ...
        <section className=' h-1/2 relative top-30 w-full flex flex-col gap-6 text-2xl text-white  '>
          ...
          <ul className="flex gap-3 w-fit pl-4 pr-4 ml-[10vw] rounded">
            <li><a className='font-bold text-sm hover:text-blue-500 cursor-pointer' href="">All</a></li>
            <li><a className='font-bold text-sm hover:text-blue-500 cursor-pointer' href="">AI</a></li>
            <li><a className='font-bold text-sm hover:text-blue-500 cursor-pointer' href="">E-commerce</a></li>
            <li><a className='font-bold text-sm hover:text-blue-500 cursor-pointer' href="">Game</a></li>
          </ul>
        </section>
